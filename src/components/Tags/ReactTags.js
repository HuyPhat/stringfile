...
export class ReactTags extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const { selectedIndex, suggestions, placeholder, inputName, maxLength } = this.state;
    ...
    const tagInput = !this.props.readOnly
      ? <div className={this.state.classNames.tagInput}>
        <div className="tagsinput-add">
          <a className="icon-add-user" href="#" onClick={(event) => {
